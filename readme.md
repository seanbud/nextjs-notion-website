...
This repo is what I use to power my personal blog and portfolio site [seanbudning.com](https://seanbudning.com).

It uses Notion as a CMS, [react-notion-x](https://github.com/NotionX/react-notion-x), [Next.js](https://nextjs.org/), and a droplet on digital ocean.
...
- [My site](https://seanbudning.com) - Deployed from the `sb` branch
